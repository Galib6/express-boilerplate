...
✅ Swagger API Documentation – Interactive API docs using OpenAPI 3.0 specifications\
\
🧪 Testing & CI/CD\
...
1. Use JSDoc comments in route files or create dedicated `.doc.ts` files
2. Check examples in:
   - `src/features/user/routes/user.routes.doc.ts`
   - `src/features/user/routes/user.routes.doc.templates.ts`
   - `src/features/user/types/swagger.schemas.ts`
   - `src/features/swagger-guide.ts`

3. Read the documentation guide in `docs/SWAGGER.md`
